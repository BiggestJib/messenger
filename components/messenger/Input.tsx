...
interface InputProps {
  ...
  errors: FieldErrors; // Corrected the errors type to match the expected usage
  disabled?: boolean;
}
...
const Input: React.FC<InputProps> = ({
  ...
  required = false, // Default required to false if not provided
  register,
  errors,
      ...
      <div className="mt-2">
        <input
          ...
          className={clsx(
            ...
            errors[id] && "focus:ring-rose-500 border-rose-500", // Added a border color for errors
